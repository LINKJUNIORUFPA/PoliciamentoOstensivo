 ...
 */
 function register_event_handlers()
 {
    ...
    {
         /*global activate_page */
         activate_page("#EsqueceuSuaSenha"); 
    });
    ...
    $(document).on("click", ".uib_w_116", function(evt)
    {
        ...
        /* button  Para Que Serve */
    $(document).on("click", ".uib_w_84", function(evt)
    {
         /*global activate_page */
         activate_page("#PraQueServe"); 
    });
    ...
    {
         /*global activate_page */
         activate_page("#DetalhesOcorrencia"); 
    });
